...
const RoomDetails = (props: { params: { slug: string } }) => {
    ...
    const handleBookNow = async () => {
        ...
        if (checkinDate > checkoutDate) return toast.error("Please! provide a valid Checkout date")
    ...
    return (
        <div>
            <HotelPhotos photos={room.images} />
                ...
                <div className="md:grid md:grid-cols-12 gap-10 px-3">
                    <div className="md:col-span-8 md:w-full">
                        <div>
                            ...
                            <div className="flex my-11">
                                {room.offeredAmenities.map(amenity => (
                                    <div key={amenity._key}
                                        className="md:w-44 w-fit text-center px-2 md:px-0 h-20 md:h-40 mr-3 bg-[#eff0f2] dark:bg-gray-700 rounded-lg grid place-content-center">
                            ...
                            <div className="mb-12">
                                <h2 className="font-bold text-2xl mb-2">Offered Amenities</h2>
                            ...
                            <div className="mb-12">
                                <h2 className="font-bold text-2xl mb-2">Safety and Hygiene</h2>
                                <div className="grid grid-cols-2">
                                    ...
                                    <div className="flex items-center my-1 md:my-0">
                                        ...
                                        <p className="ml-2 md:text-base text-xs">Disienfections and Sterilizations</p>
                                    </div>
                                    <div className="flex items-center my-1 md:my-0">
                                        <GiSmokeBomb />
