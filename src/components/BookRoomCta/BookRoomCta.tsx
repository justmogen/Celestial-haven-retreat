...
type Props = {
    ...
    setNoChildren: Dispatch<SetStateAction<number>>
    ...
    return (
        <div className="px-7 py-6">
            <h3>
                ...
                {discount ? <span className="font-bold text-xl"> | discount {discount}%. Now <span className="text-tertiary-dark" >${discountPrice}</span>
                </span> : ''}
            </h3>
